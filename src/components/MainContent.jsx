...
import { Wrapper, CardLists } from "../components";
...
const MainContent = () => {
  ...
  useEffect(() => {
    theme === "light"
      ? (Body.style.background = `linear-gradient(180deg, #1a306c 0%, #152156 50%, #04060f 100%) center/cover no-repeat fixed`)
      : (Body.style.background = `linear-gradient(180deg, #04060f 0%, #090e25 50%, #1a306c 100%) center/cover no-repeat fixed`);
  }, [theme]);
